...
//       // Get form values from the controllers
...
//           Uri.parse('http://10.0.2.2:3000/labtechnician/register'), // Update with your server URL
...
//             } else {
//               ScaffoldMessenger.of(context).showSnackBar(
//                 SnackBar(content: Text('passed: ${jsonResponse['message']}')),
//               );
//             }
//           } else {
//             ScaffoldMessenger.of(context).showSnackBar(
//               SnackBar(
//                   content: Text(
//                       'Error ${response.statusCode}: ${jsonResponse['message']}')),
//             );
//           }
//         } else {
//           ScaffoldMessenger.of(context).showSnackBar(
//             SnackBar(content: Text('Unexpected error: No response from server')),
//           );
//         }
//       } catch (e) {
